<!-- フリーランスサミット情報セクション -->
<section class="about-event-container" style="background-image: url('img/about/about.svg'); background-size: cover; background-position: center;">
    <!-- フリーランスサミットとは？セクション -->
    ...
    <!-- イベント開催概要セクション -->
    <div class="event-summary" id="summary">
        <div class="container">
