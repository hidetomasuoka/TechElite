...
<main>
    ...
    <section class="schedule-section" id="schedule" style="background-image: url('img/speakers/back.png'); background-size: cover; background-position: center; padding: 80px 0;">
        <div class="container">
            <div class="section-header">
                <div class="section-title-en">Time Schedule</div>
                <h2 class="section-title-jp"><span class="title-line"></span>タイムスケジュール<span class="title-line"></span></h2>
            </div>
